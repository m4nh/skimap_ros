...
class SkiMap : public SkipListMap<V, K, D, X_DEPTH, Y_DEPTH, Z_DEPTH>
{
  public:
    ...
    /**
         ...
         * @param resolution_z
         */
    SkiMap(K min_index, K max_index, D resolution_x, D resolution_y, D resolution_z, D zero_level = D(0.0)) : ParentMap(min_index, max_index, resolution_x, resolution_y, resolution_z)
    {
