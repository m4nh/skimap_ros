...
MACRO(FIND_G2O_LIBRARY MYLIBRARY MYLIBRARYNAME)
  ...
  IF(NOT ${MYLIBRARY}_DEBUG)
    IF(${MYLIBRARY}_RELEASE)
      SET(${MYLIBRARY}_DEBUG ${${MYLIBRARY}_RELEASE})
    ENDIF(${MYLIBRARY}_RELEASE)
  ENDIF(NOT ${MYLIBRARY}_DEBUG)
  
  SET(${MYLIBRARY}
    debug ${${MYLIBRARY}_DEBUG}
    optimized ${${MYLIBRARY}_RELEASE}
  )

  MARK_AS_ADVANCED(FORCE ${MYLIBRARY}_DEBUG ${MYLIBRARY}_RELEASE ${MYLIBRARY})
